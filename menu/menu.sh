...
do
    case $act in
        "Query")
            ls -ld /data /home/ubuntu /home/student/Desktop/Double-Click-2-Run-Labs /home/student/NGINX-Fundamentals-Labs/ /var/log/nginx/*{access,error}.log /etc/nginx/conf.d/default.* ;;
        "Wipe")
